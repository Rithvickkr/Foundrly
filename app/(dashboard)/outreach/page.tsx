...
export default function OutreachCampaignPage() {
  ...
  const fetchPitchDecks = async () => {
    try {
      ...
      setPitchDecks(
        data.map((deck: any) => ({ id: deck.id, title: deck.title }))
      );
    } catch (error) {
      ...
      >
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-base text-gray-400 max-w-2xl">
            Launch targeted outreach campaigns for your pitch decks to reach
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="bg-gray-800 text-gray-100 border-gray-700">
                        <p>A descriptive name for your outreach campaign.</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
              ...
              <div className="space-y-2">
                ...
                {pitchDecks.length === 0 && !isLoading && (
                  <p className="text-xs text-gray-400">
                    You need to create a pitch deck first before creating a
                    campaign.
                  </p>
                )}
              </div>
