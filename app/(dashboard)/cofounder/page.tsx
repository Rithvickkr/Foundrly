...
const CofounderRoom: React.FC = () => {
  ...
  const itemsPerPage = 9; // Adjust as needed (9 for 3x3 grid)
  ...
  const filteredDecks = useMemo(() => {
    return decks.filter((deck) => {
      ...
      return matchesSearch && matchesIndustry && matchesStage && matchesTargetMarket;
    });
  }, [decks, searchQuery, selectedIndustry, selectedStage, selectedTargetMarket]);
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 dark:from-gray-900 dark:via-blue-900/10 dark:to-indigo-900/20">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 hidden sm:block">
                  Manage your startup ideas and collaborate with AI
                </p>
              </div>
            </div>
        ...
        <div className="hidden md:block px-6 py-4 bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm border-b border-gray-200/30 dark:border-gray-700/30">
                ...
                <AnimatePresence>
                  {paginatedDecks.map((deck, index) => (
                    ...
                    >
                      ...
                      `}
                      >
                        {/* Glowing background effect as pseudo-element */}
                        <div
                        ...
                        <div className="flex justify-between items-start mb-5 relative">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-3">
                              <div className="p-2 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 text-blue-600 dark:text-blue-400">
                                {getIndustryIcon(deck.industry)}
                              </div>
                              <motion.h3
                                className="text-lg font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors truncate"
                                whileHover={{ scale: 1.02 }}
                              >
                                {deck.title}
                              </motion.h3>
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              <motion.span
                                whileHover={{ scale: 1.05 }}
                                className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${getStageColor(
                                  deck.startup_stage
                                )}`}
                              >
                              ...
                              <motion.span
                                whileHover={{ scale: 1.05 }}
                                className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 dark:from-gray-700/40 dark:to-gray-600/40 dark:text-gray-300 border border-gray-300/50"
                              >
                        ...
                        {/* Description */}
                        <motion.p
                          className="text-gray-600 dark:text-gray-300 text-sm mb-5 line-clamp-3 leading-relaxed"
                          initial={{ opacity: 0.8 }}
                        ...
                        <div className="flex justify-between items-center pt-4 border-t border-gray-200/50 dark:border-gray-700/50">
                          ...
                          <div className="flex items-center space-x-2">
                            <motion.button
                              ...
                              className="p-2 rounded-lg bg-gray-100 dark:bg-gray-700/50 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                            >
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.95 }}
                              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs rounded-lg transition-all hover:from-blue-600 hover:to-indigo-700 shadow-lg"
                            >
