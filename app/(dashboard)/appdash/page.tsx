...
export default function Dashboard() {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      sender: "AI",
      message: "Hi! I'm your AI assistant. I can help you with pitch deck creation, investor outreach, and answer any questions about our platform. What would you like to know?",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-950 dark:to-indigo-950 text-gray-800 dark:text-gray-100 relative overflow-hidden">
      ...
      <Card className="bg-white dark:bg-gray-800 shadow-2xl rounded-t-2xl h-full flex flex-col border-t border-gray-200 dark:border-gray-700 backdrop-blur-lg">
        ...
        <CardContent className="flex-1 p-0 overflow-hidden bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-800/50 dark:to-gray-800">
        <ScrollArea className="h-full">
        <div className="h-full overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent" id="chat-messages">
          ...
          >
            <div className="bg-white dark:bg-gray-700 text-gray-800 dark:text-white border border-gray-200 dark:border-gray-600 max-w-[85%] p-3 rounded-2xl text-sm font-medium shadow-lg">
            <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <Input
          type="text"
          placeholder="Ask about pitch decks, features, or get help..."
          value={message}
          ...
          >
          <Button
            className="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-xl p-3 shadow-lg disabled:opacity-50"
